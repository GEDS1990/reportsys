	...
	<div class="easyui-layout" data-options="fit:true"
		...
		<div data-options="region:'north',split:true"
			...
			<span style="float: right; padding-right: 20px;" class="head">${user.username}
				...
				onclick="editPass()">修改密码</a>
			
				<a class="easyui-linkbutton"  plain="true"
					href="user/logOut">安全退出</a>
				...
				<c:forEach items="${parentMenu}" var="parent" varStatus="ddd">
					...
					<c:if test="${!empty parent.url}">
						<ul><div class="nav-item">
								<a href="javascript:addTab('${parent.name}','page/${parent.url}')">
		...
		<div data-options="region:'south'"
			...
			<div class="footer">By LL2104@163.com</div>
		</div>
		<div id="mainPanle" data-options="region:'center'"
			...
			<div id="tabs" class="easyui-tabs" fit="true" border="false">
				<div title="欢迎使用,双击此处关闭所有选项"
					style="padding: 20px; overflow: hidden;" id="home">

					<h1>Welcome to ReportSystem!</h1>
			...
			<table style="width: 100%; font-size: 12px; font-weight: normal">
				...
				<tr>
					<td style="text-align: right" colspan=2><input type="button"
						onclick="editPass_cancel()" class="subbtn" value="取消"> <input type="button"
						onclick="changePass_submit()" class="subbtn" value="提交"></td>
				</tr>
